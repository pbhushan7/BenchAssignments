...
class Percentage
{
	...
	static void Main(string[] args)
	{
		...
		if (marks1 > (marks2 & marks3))
		{
			//if (marks1 > marks3)
			//{
			//	Console.Write("The marks in subject 1 is the greatest among three. \n\n");
			//}
			//else
			//{
			//	Console.Write("The marks in subject 3 is the greatest among three. \n\n");
			//}
			Console.Write("The marks in subject 1 is the greatest among three. \n\n");
		}
		else if (marks2 > marks3)
			Console.Write("The marks in subject 2 is the greatest among three \n\n");
		else
			Console.Write("The marks in subject 3 is the greatest among three \n\n");
	}
